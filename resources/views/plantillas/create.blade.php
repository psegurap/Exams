        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="template_info.name" class="form-control single-input-form" placeholder="Coloca el nombre del examen...">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select v-model="template_info.materia" name="" id="" class="form-control single-input-form">
                                    ...
                                    <option value="1">officiis architecto ipsa</option>
                                    <option value="2">placeat labore voluptatem</option>
                                    <option value="3">quibusdam in ab</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="test-records">
                        <div class="row">
                            <div class="col-12 mb-2">
                                <div class="test-records">
                                    <div class="row">
                                        <div v-for="(pregunta,index) in CurrentTema[0].preguntas" class="col-12 mb-2">
                                                    ...
                                                    <div class="col-3">
                                                        <div class='d-flex justify-content-end'>
                                                            <div class='text-info mr-2 fa-lg' style='font-size: 1.5em;'>
                                                                <i style='cursor:pointer' title="Editar Tema" class='fa fa-pencil-square-o' aria-hidden='true'></i>
                                                            </div>
                                                            <div class='text-danger mr-2 fa-lg' style='font-size: 1.5em;'>
                                                                <i style='cursor:pointer' title="Eliminar Tema" class='fa fa-trash' aria-hidden='true'></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group" v-if="CurrentTema[0].tipo == 'selectMultiple'">
                                                            <div v-for="(opcion, ind) in pregunta.opciones" class="custom-control custom-radio custom-control-inline">
            ...
            <div v-if="CurrentTema.length > 0 && CurrentTema[0].preguntas.length > 0" class="col-12 mb-2">
                <div class="text-right">
                    <button class="btn btn-success rounded-0 ml-2" :disabled="template_info.name == '' || template_info.materia == '' || template_info.descripcion == ''">Guardar Examen</button>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger btn-sm rounded-0" data-dismiss="modal">{{__('Cerrar')}}</button>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                            ...
                            <aside class="col-md-12" v-if="CurrentTema.length > 0 && CurrentTema[0].tipo == 'selectMultiple'">
                                <div>
                                    ...
                                    <div v-for="opcion in pregunta.opciones" class="d-inline-block m-1">
                                        <span class="btn btn-sm btn-info btn-section rounded-0 text-left">@{{opcion}}</span>
                                    </div>
                                </div>
                            </aside>
                        </section>
                    ...
                    <div class="modal-footer">
                        ...
                        <button v-if="pregunta_view == 'edit'" type="button" @click="validate(updateTema)" class="btn btn-warning btn-sm rounded-0">{{__('Actualizar')}}</button>
                        <button type="button" class="btn btn-danger btn-sm rounded-0" data-dismiss="modal">{{__('Cerrar')}}</button>
                    {{-- <button v-if="view == 'edit'" type="button" @click="validate(updateCategory)" class="btn btn-info">{{__('Update Category')}}</button> --}}
                    </div>
                </div>
    ...
    <script>
        ...
        var main = new Vue({
            ...
            methods: {
                ...
                agregarOpcion: function(pregunta_id){
